    ...
    <section className="rounded-[2rem] bg-slate-900/90 px-5 py-7 shadow-soft ring-1 ring-white/10 sm:px-6">
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <Link href="/planes" className="inline-flex w-full items-center justify-center rounded-full bg-cyan-500 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-cyan-400 sm:w-auto">
            Regístrate ahora
          </Link>
