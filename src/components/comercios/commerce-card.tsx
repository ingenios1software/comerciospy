...
export function CommerceCard({ comercio }: CommerceCardProps) {
  ...
  return (
    <Link href={`/comercios/${comercio.id}`} className="group block overflow-hidden rounded-3xl bg-slate-900/95 shadow-soft ring-1 ring-white/10 transition duration-300 hover:-translate-y-0.5 hover:bg-slate-800">
