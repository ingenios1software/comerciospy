import type { Comercio, CommercePreview, Publicacion, SolicitudCliente } from '@/types';
...
export const featuredComercios: CommercePreview[] = [
  {
    ...
    destacado: true,
    verificado: true,
    valoracion: { promedio: 4.9, total: 128 },
    ubicacion: { lat: -25.2867, lng: -57.3333 },
  ...
  },
  {
    ...
    planNombre: 'Plan Destacado',
    destacado: true,
    verificado: true,
    valoracion: { promedio: 4.8, total: 74 },
    ubicacion: { lat: -25.3217, lng: -57.5408 },
  ...
  },
  {
    ...
    valoracion: { promedio: 4.7, total: 36 },
    ubicacion: { lat: -25.2674, lng: -57.4872 },
  ...
  },
  {
    ...
    destacado: true,
    verificado: true,
    valoracion: { promedio: 5, total: 91 },
    ubicacion: { lat: -25.3397, lng: -57.5088 },
...
export const sampleSolicitudes: SolicitudCliente[] = [
  {
    id: 's1',
    texto: 'Necesito electricista para hoy. Es para revisar una llave termica en casa.',
    ...
    estado: 'activa',
    creadoEn: '2026-06-05T09:30:00.000Z'
  },
  {
    id: 's2',
    texto: 'Busco tractorista para manana, zona rural cercana a Luque.',
    categoria: 'Servicios',
    ciudad: 'Luque',
    nombre: 'Productor local',
    whatsapp: '+595982333444',
    estado: 'activa',
    creadoEn: '2026-06-05T13:15:00.000Z'
  },
  {
    id: 's3',
    texto: 'Necesito presupuesto para instalar aire acondicionado en un local pequeno.',
    categoria: 'Vivienda',
    ciudad: 'Fernando de la Mora',
    nombre: 'Comercio',
    whatsapp: '+595983555666',
    estado: 'activa',
    creadoEn: '2026-06-06T10:00:00.000Z'
  }
];
